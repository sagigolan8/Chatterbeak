...
export default function App() {
  ...
  const checkRating = () =>{
    let rating 
      ...
      return errorNotification('Please rate us, and fill all fields','top-center')
  }
    ...
    <div style={allowEdit} className="container-feedback">
      <div className="feedback">
        <div className="rating">
          ...
          <input type="radio" name="rating" className="rates" id="rating-4"/>
          <label htmlFor="rating-4"></label>
          <input type="radio" name="rating" className="rates" id="rating-3"/>
          <label htmlFor="rating-3"></label>
          <input type="radio" name="rating" className="rates" id="rating-2"/>
          <label htmlFor="rating-2"></label>
          <input type="radio" name="rating" className="rates" id="rating-1"/>
